...
def intersection(box_mask_list1, box_mask_list2):
    ...
    """
    return np_mask_ops.intersection(box_mask_list1, box_mask_list2)
...
def iou(box_mask_list1, box_mask_list2):
    ...
    """
    return np_mask_ops.iou(box_mask_list1, box_mask_list2)
...
def non_max_suppression(
    box_mask_list, max_output_size=10000, iou_threshold=1.0, score_threshold=-10.0
):
